...
public class ppCube2_p4 extends SequentialCommandGroup
{
    ...
    public ppCube2_p4(ArmExtensionSubsystem extend, ArmRotationSubsystem arm, IntakeSubsystem intake, ArmWristSubsystem wrist) {
        ...
        List<PathPlannerTrajectory> path2Back = PathPlanner.loadPathGroup("Cube2_p4", new PathConstraints(4, 2));

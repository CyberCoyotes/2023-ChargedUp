...
public class CubeLowTaxi extends SequentialCommandGroup
{
    ...
    public CubeLowTaxi(Swerve s_Swerve, ArmExtensionSubsystem extend, ArmSubsystem arm, IntakeSubsystemV2 intake, WristSubsystem wrist, BooleanSupplier robotCentric) {

...
public class PickupGroundCube extends SequentialCommandGroup{
    ...
    (ArmRotationSubsystem armSub, ArmWristSubsystem wristSub, IntakeSubsystem intakeSub, ArmExtensionSubsystem extend, double position) {
        addCommands(
            ...
            new ArmExtendToFloor(extend, position), 
            // TODO Test 1.6 --> 1.5
            // 8220+1200 = 9420

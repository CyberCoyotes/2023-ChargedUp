...
public class cgCubeDeployMiddle extends SequentialCommandGroup {
    ...
    public cgCubeDeployMiddle(ArmSubsystem m_ArmSub, ArmExtensionSubsystem m_ArmExtSub, ClawSubsystem m_ClawSub) {
        ...
        addCommands(
                ...
                new m_ArmSub.RotateArmToDegrees(90), // Rotate the arm to approximately 90 degrees. Determine experimentally
                ...
                new m_ArmSub.RotateArmToDegrees(-70), // Rotate the arm to approximately 90 degrees (again to compensate for
